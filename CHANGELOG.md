...
- [#xxx](https://github.com/nf-core/proteinfamilies/pull/xxx)
  - Conditional workflow flags switched to their `skip` opposites; `--trim_msa` to `--skip_msa_trimming`. (by @vagkaratzas)
- [#118](https://github.com/nf-core/proteinfamilies/pull/118)
...
- [#xxx](https://github.com/nf-core/proteinfamilies/pull/xxx) - Deprecated `--trim_msa`. (by @vagkaratzas)
