...
- [#182](https://github.com/nf-core/proteinfamilies/pull/#182) - Updated `CHUNK_CLUSTERS` to optionally output `TSV` instead of `FASTA`, required by the iterative family generation subworkflow. (by @vagkaratzas)
