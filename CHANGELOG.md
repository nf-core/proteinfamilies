...
- [#133](https://github.com/nf-core/proteinfamilies/pull/133) - Added two new local modules that prepare the downstream `nf-core/proteinfold` samplesheet. (by @vagkaratzas)
